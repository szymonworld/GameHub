...
public class Browser_WebClient
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GameHub.Browser+WebClient, GameHub, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", Browser_WebClient.class, __md_methods);
	}


	public Browser_WebClient () throws java.lang.Throwable
	{
		super ();
		if (getClass () == Browser_WebClient.class)
			mono.android.TypeManager.Activate ("GameHub.Browser+WebClient, GameHub, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
