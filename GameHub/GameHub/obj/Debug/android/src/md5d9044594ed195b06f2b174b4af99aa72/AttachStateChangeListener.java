package md5d9044594ed195b06f2b174b4af99aa72;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DesignLibrary.Helpers.AttachStateChangeListener, GameHub, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AttachStateChangeListener.class, __md_methods);
	}
	...
	public AttachStateChangeListener () throws java.lang.Throwable
	{
		...
		if (getClass () == AttachStateChangeListener.class)
			mono.android.TypeManager.Activate ("DesignLibrary.Helpers.AttachStateChangeListener, GameHub, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
